        ...
        {showPopup && (
          ...
          >
            ...
            >
              ...
              <motion.button
                className="bg-gradient-to-r from-slate-900 to-slate-700 text-white px-6 py-2 rounded-lg hover:bg-slate-700 transition-colors"
          ...
          <div className="flex flex-col flex-1 gap-6">
            ...
            >
              <motion.button 
                ...
                className="w-full py-3 bg-gradient-to-r from-slate-900 to-slate-700 text-white rounded-lg hover:bg-slate-700 disabled:opacity-50 transition-colors shadow-md"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                {loading ? (
